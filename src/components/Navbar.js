            ...
            <div className="h-[10vh] w-[100%] bg-white flex flex-row justify-center items-center">
                <div className="w-[90%] flex justify-between items-center">
                    ...
                    <div className='flex justify-center items-center gap-4 lg:text-sm text-bg_text_gray hidden lg:flex items-center w-full lg:w-auto'>
                        <Link className={currentTab === 'home' ? `px-[1.2rem] py-2 bg-bg_gray rounded-lg text-blue font-semibold lg:px-[0.8rem]` : `px-[1.2rem] py-2 lg:px-[0.5rem]`} href='/home'>Home</Link>
                        <Link className={currentTab === 'courses' ? `px-[1.2rem] py-2 bg-bg_gray lg:px-[0.5rem] rounded-lg text-blue font-semibold lg:px-[0.8rem]` : `px-[1.2rem] py-2 lg:px-[0.5rem]`} href='/courses'>Courses</Link>
                        <Link className={currentTab === 'about' ? `px-[1.2rem] py-2 bg-bg_gray lg:px-[0.5rem] rounded-lg text-blue font-semibold lg:px-[0.8rem]` : `px-[1.2rem] py-2 lg:px-[0.5rem]`} href='/about'>About Us</Link>
                        <Link className={currentTab === 'contact' ? `px-[1.2rem] py-2 bg-bg_gray lg:px-[0.5rem] rounded-lg text-blue font-semibold lg:px-[0.8rem]` : `px-[1.2rem] py-2 lg:px-[0.5rem]`} href='/contact'>Contact Us</Link>
                    </div>
                    ...
                    <button className="py-2 px-4 hidden lg:flex justify-between items-center w-full lg:w-auto bg-blue text-white rounded-lg">Get started</button>
                </div>
            </div>
                ...
                <>
                    ...
                    <div className="lg:hidden fixed inset-0 bg-white flex flex-col justify-center items-center z-0">
                        <div className="flex flex-col items-center gap-4">
                            <Link className="px-[1.2rem] py-2 lg:px-[0.5rem] rounded-lg" href='/home'>Home</Link>
                            <Link className="px-[1.2rem] py-2 lg:px-[0.5rem]" href='/courses'>Courses</Link>
                            <Link className="px-[1.2rem] py-2 lg:px-[0.5rem]" href='/about'>About Us</Link>
                            <Link className="px-[1.2rem] py-2 lg:px-[0.5rem]" href='/contact'>Contact Us</Link>
                            <button className="py-2 px-4 bg-blue text-white rounded-lg mt-4">Get started</button>
                        </div>
                    </div>
                </>
            )}
